           ...
           <div>
                <div className='Parallax'>
                    ...
                    <div className='buleud' style={{marginTop: '5%'}}>
                        <svg className="bi bi-chevron-double-down" width="2em" height="2em" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='content'> 
                        ...
                        <div className='arrow'>
                            <svg className="bi bi-chevron-down" width="2em" height="3em" viewBox="0 0 16 16" fill="grey" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-sm">
                                            <Card className="card">
                                                <CardImg top width="100%" src="https://i.pinimg.com/564x/7f/eb/57/7feb574678e360c91813bb13a0f31c15.jpg" alt="Card image cap" />
                                                <CardBody>
                                        ...
                                        <div className="col-sm">
                                            <Card className="card">
                                                <CardImg top width="100%" src="https://i.pinimg.com/564x/3c/66/f8/3c66f856064fc3dbdfad9ecc0a2bc3a3.jpg" alt="Card image cap" />
                                                <CardBody>
                                                <CardTitle>Card title</CardTitle>
                                                <CardSubtitle>Card subtitle</CardSubtitle>
                                                <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                                        ...
                                        <div className="col-sm">
                                            <Card className="card">
                                                <CardImg top width="100%" src="https://i.pinimg.com/564x/81/f0/96/81f09667b1e14675bb98f71578577b0f.jpg" alt="Card image cap" />
                                                <CardBody>
                                                <CardTitle>Card title</CardTitle>
                                                <CardSubtitle>Card subtitle</CardSubtitle>
                                                <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                                        ...
                                        <div className="col-sm">
                                            <Card className="card">
                                                <CardImg top width="100%" src="https://i.pinimg.com/564x/1a/a2/1b/1aa21b5e6dd61a1a1a3494e39cd5a064.jpg" alt="Card image cap" />
                                                <CardBody>
                                                <CardTitle>Card title</CardTitle>
                                                <CardSubtitle>Card subtitle</CardSubtitle>
                                                <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                ...
                <div className='content2'>
                    ...
                    <div className='arrow'>
                            ...
                            <div className='container'>
                                <div className="row">
                                    <div className='col-sm'>
                                        <svg className="bi bi-house-fill" width="5em" height="5em" viewBox="0 0 16 16" fill="#717171" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='col-sm'>
                                        <svg className="bi bi-heart-half" width="5em" height="5em" viewBox="0 0 16 16" fill="#717171" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='col-sm'>
                                            <svg className="bi bi-shield-lock" width="5em" height="5em" viewBox="0 0 16 16" fill="#717171" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='col-sm'>
                                            <svg className="bi bi-star" width="5em" height="5em" viewBox="0 0 16 16" fill="#717171" xmlns="http://www.w3.org/2000/svg">
