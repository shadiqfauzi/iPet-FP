...
const TransactionStatusPagination = (props) => {
	const { currentPage, setCurrentPage, handlePage } = props

	const totalData = useSelector((state) => state.transactionStatus.totalData)
	const totalPage = Math.ceil(totalData / 15)
...
export default TransactionStatusPagination
